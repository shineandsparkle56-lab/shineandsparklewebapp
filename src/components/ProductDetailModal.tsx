          ...
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-3 sm:p-4">
              ...
              >
                ...
                {/* ── IMAGE PANEL ─────────────────────────────────────── */}
                {/*
                  Mobile  : full-width 1:1 square (aspect-square)
                  Desktop : half the modal width, full modal height
                */}
                <div className="relative flex-shrink-0 w-full md:w-1/2 bg-[#F3EEFB] flex flex-col">
                  ...
                  {/*
                    Main image:
                    - Mobile: 1:1 square via aspect-square
                    - Desktop: stretches to fill the column height (flex-1 + min-h-0)
                      so the image is always fully visible without cropping the sides
                  */}
                  <div className="aspect-square md:aspect-auto md:flex-1 md:min-h-0 relative overflow-hidden">
